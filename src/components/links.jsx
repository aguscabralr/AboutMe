...
const Links = () => {
  ...
  return (
    <section id='link' className='w-full md:w-16 md:h-full flex justify-center items-center md:fixed top-0 left-0 z-10'>
      <div className='w-full p-1 landscape:p-2 flex md:flex-col justify-center items-center gap-2 landscape:gap-5 rounded-r-2xl bg-zinc-800 md:opacity-30 hover:opacity-100 duration-300'>
