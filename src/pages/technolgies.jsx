...
const Technolgies = () => {
  return (
    <section id='tech'>
      ...
      <article id='tcont' className='w-full py-16 px-[5%] text-[--txt] flex flex-col gap-[10svh]'>
        <div className='w-full h-[15svh] max-h-[75px] md:max-h-24 lg:max-h-40 flex items-center gap-5 lg:gap-10'>
          <h2 id='latx' className='flex-grow text-end lg:text-3xl xl:text-4xl'>
            Lenguajes
          </h2>
          <div id='laic' className='z-10 flex-grow h-full flex flex-col items-start'>
            <div className='w-fit h-full p-3 flex items-center gap-2 lg:gap-10 bg-zinc-800 border-2 border-[--txt] rounded-tr-xl rounded-br-xl'>
              {languages.map((lang, idx) => {
                return (
                  <div key={idx} id={lang.abv} className='h-full flex justify-center items-center relative hover:cursor-pointer'>
        ...
        <div className='w-full h-[15svh] max-h-[75px] md:max-h-24 lg:max-h-40 flex items-center gap-5 lg:gap-10'>
          <div id='fric' className='z-10 flex-grow h-full flex flex-col items-end'>
            <div className='w-fit h-full p-3 flex items-center gap-2 lg:gap-10 bg-zinc-800 border-2 border-[--txt] rounded-tl-xl rounded-bl-xl'>
              {fronts.map((front, idx) => {
                return (
                  <div key={idx} id={front.abv} className='h-full flex justify-center items-center relative hover:cursor-pointer'>
        ...
        <div className='w-full h-[15svh] max-h-[75px] md:max-h-24 lg:max-h-40 flex items-center gap-5 lg:gap-100'>
          <h2 id='sttx' className='flex-grow text-end lg:text-3xl xl:text-4xl'>
            Styles
          </h2>
          <div id='stic' className='z-10 flex-grow h-full flex flex-col items-start'>
            <div className='w-fit h-full p-3 flex items-center gap-2 lg:gap-10 bg-zinc-800 border-2 border-[--txt] rounded-tr-xl rounded-br-xl'>
              {styles.map((style, idx) => {
                return (
                  <div key={idx} id={style.abv} className='h-full flex justify-center items-center relative hover:cursor-pointer'>
        ...
        <div className='w-full h-[15svh] max-h-[75px] md:max-h-24 lg:max-h-40 flex items-center gap-5 lg:gap-10'>
          <div id='baic' className='z-10 flex-grow h-full flex flex-col items-end'>
            <div className='w-fit h-full p-3 flex items-center gap-2 lg:gap-10 bg-zinc-800 border-2 border-[--txt] rounded-tl-xl rounded-bl-xl'>
              {backs.map((back, idx) => {
                return (
                  <div key={idx} id={back.abv} className='h-full flex justify-center items-center relative hover:cursor-pointer'>
        ...
        <div className='w-full h-[15svh] max-h-[75px] md:max-h-24 lg:max-h-40 flex items-center gap-5 lg:gap-10'>
          ...
          <div id='daic' className='z-10 flex-grow h-full flex flex-col items-start'>
            <div className='w-fit h-full p-3 flex items-center gap-2 lg:gap-10 bg-zinc-800 border-2 border-[--txt] rounded-tr-xl rounded-br-xl'>
              {datas.map((data, idx) => {
                return (
                  <div key={idx} id={data.abv} className='h-full flex justify-center items-center relative hover:cursor-pointer'>
        ...
        <div className='w-full h-[15svh] max-h-[75px] md:max-h-24 lg:max-h-40 flex items-center gap-5 lg:gap-10'>
          <div id='toic' className='z-10 flex-grow h-full flex flex-col items-end'>
            <div className='w-fit h-full p-3 flex items-center gap-2 lg:gap-10 bg-zinc-800 border-2 border-[--txt] rounded-tl-xl rounded-bl-xl'>
              {tools.map((tool, idx) => {
                return (
                  <div key={idx} id={tool.abv} className='h-full flex justify-center items-center relative hover:cursor-pointer'>
