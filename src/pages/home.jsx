const Home = () => {
  return (
    <section id='home' className='w-full h-[130svh] pt-16'>
      <article id='heroxs' className='w-full h-[calc(100svh-64px)] px-[10%] flex flex-col justify-center items-center lg:hidden'>
        ...
        <div id='contxs' className='w-full h-[20%] max-h-24 px-2 flex flex-col justify-center items-center gap-2 bg-[--crd] text-[--sme] shadow-[--txt] shadow-lg rounded-2xl z-10'>
      ...
      <article id='heroxl' className='w-full h-[calc(100svh-64px)] px-[15%] hidden lg:flex justify-center items-center'>
        <div id='contxl' className='w-full h-[40%] min-h-24 max-h-40 px-10 flex justify-evenly items-center bg-[--crd] text-[--sme] shadow-[--txt] shadow-lg rounded-3xl z-10'>
          <div id='txxl' className='flex flex-col justify-center items-center gap-2'>
      ...
      <article id='abcont' className='w-full h-[45svh] pb-16 px-[10%] lg:px-[15%] flex flex-col justify-end gap-5 xs:text-[3.2vw] sm:text-[3.3vw] md:text-[2.8vw] landscape:text-[1.45vw] text-pretty'>
