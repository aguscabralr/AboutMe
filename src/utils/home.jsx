...
const HomeSVG = () => {
  ...
  return (
    <svg className={`hover:fill-[--btn] hover:scale-125 duration-300 hover:cursor-pointer`} fill={color} width='30px' height='30px' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
