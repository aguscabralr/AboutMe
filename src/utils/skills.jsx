...
const SkillsSVG = () => {
  ...
  return (
    <svg className={`hover:fill-[--btn] hover:scale-125 duration-300 hover:cursor-pointer`} fill={color} height='30px' width='30px' version='1.1' id='Layer_1' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 232.688 232.688' xmlSpace='preserve'>
      <g id='XMLID_169_'>
        <g id='XMLID_197_'>
          <path
            id='XMLID_221_'
